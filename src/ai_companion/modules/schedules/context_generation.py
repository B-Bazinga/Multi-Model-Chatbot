...
class ScheduleContextGenerator:
    """Class to generate context about Mikasa's current activity based on schedules."""
    ...
    def get_current_activity(cls) -> Optional[str]:
        """Get Mikasa's current activity based on the current time and day of the week.
