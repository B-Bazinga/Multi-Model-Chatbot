...
class AICompanionState(MessagesState):
    ...
    Attributes:
        last_message (AnyMessage): The most recent message in the conversation, can be any valid, LangChain message type (HumanMessage, AIMessage, etc.)
        ...
        current_activity (str): The current activity of Mikasa based on the schedule.
